...
ActiveRecord::Schema.define(version: 2023_05_24_032921) do
  ...
  create_table "coordinators", force: :cascade do |t|
    ...
    t.index ["authentication_token"], name: "index_coordinators_on_authentication_token", unique: true
  ...
  create_table "respondents", force: :cascade do |t|
    ...
    t.datetime "updated_at", precision: 6, null: false
    t.string "authentication_token", limit: 30
    t.index ["authentication_token"], name: "index_respondents_on_authentication_token", unique: true
